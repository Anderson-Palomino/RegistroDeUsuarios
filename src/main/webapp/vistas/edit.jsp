                ...
                <form action="PrincipalServlet">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="estado" name="estado" required>
                            <option value="Activo" <c:if test="${u.getEstado() == 'Activo'}">selected</c:if>>Activo</option>
                            <option value="Suspendido" <c:if test="${u.getEstado() == 'Suspendido'}">selected</c:if>>Suspendido</option>
                            <option value="Eliminado" <c:if test="${u.getEstado() == 'Eliminado'}">selected</c:if>>Eliminado</option>
                        </select>
                    </div>
